...
var Reveal = (function(){
	...
	function onDocumentKeyDown( event ) {
		...
		// modifier is present
		if ( document.querySelector( 'input:focus' ) !== null || event.shiftKey || event.altKey || event.ctrlKey || event.metaKey ) return;
...
//			case 74: case 40: navigateDown(); triggered = true; break;
	...
	function updateControls() {
		...
		[ dom.controlsLeft, dom.controlsRight ].forEach( function( node ) {
